<?php
	if ( ! current_user_can( 'manage_options' ) )
		wp_die( __( 'You do not have sufficient permissions to access this page.', 'wporphanageex' ) );
	...
	if ( isset( $_POST['options_update'] ) ) {
		...
		echo '<div class="updated"><p><strong>' . __( 'Settings saved', 'wporphanageex' ) . '</strong></p></div>';
	}
